...
This tree was auto-generated by [Pancake](https://github.com/da1z/pancake)`;
		...
		describe("when toggling Pancake attribution line", () => {
			const treeOnlyFooter = `
...
* **PR #83** 👈`;
			...
			const withAttributionFooter = `${treeOnlyFooter}

This tree was auto-generated by [Pancake](https://github.com/da1z/pancake)`;

			it("replaces a footer that included Pancake attribution with a tree-only footer", () => {
				const existingBody = `Description here

${withAttributionFooter}`;

				const updated = updatePrBodyFooter(existingBody, treeOnlyFooter);

				expect(updated).toBe(`Description here

${treeOnlyFooter}`);
			});

			it("replaces a tree-only footer with a footer that includes Pancake attribution", () => {
				const existingBody = `Description here

${treeOnlyFooter}`;

				const updated = updatePrBodyFooter(existingBody, withAttributionFooter);
